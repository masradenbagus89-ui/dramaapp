#!/usr/bin/env node
// engine/ensure-preflight-ci.mjs - Pasang workflow CI "Gerbang mutu otomatis" ke project klien (OPT-IN).
//
...
//
// SIFAT (cermin engine/ensure-risk-gate-hook.mjs - pola pemasang yang sudah teruji):
...
// readTextOrNull: dipindah ke sumber bersama engine/fs-text.mjs sebagai readTextSafe (audit
// fungsi-kembar 2026-07-18) -> perilaku identik (baca UTF-8 + buang BOM, null kalau gagal).
...
// --- CLI: `node engine/ensure-preflight-ci.mjs [--project-root <dir>] [--dry-run] [--force]` ---
function main() {
