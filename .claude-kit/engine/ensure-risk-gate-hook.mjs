...
// hapus massal, DROP TABLE, force-push, sentuh .env) ikut tersalin ke klien (.claude-kit/engine/), TAPI
...
//
// SIFAT (cermin engine/lang-hook-wiring.mjs - pola pemasang-hook yang sudah teruji):
...
export const RISK_GATE_HOOK_COMMAND = 'node .claude-kit/engine/risk-gate.js'
...
// --- CLI: `node engine/ensure-risk-gate-hook.mjs [--project-root <dir>] [--dry-run]` ---
function main() {
