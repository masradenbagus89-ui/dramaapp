#!/usr/bin/env node
// engine/feedback-aggregate.mjs - Agregator berkas "Rekam Pelajaran" owner-side, DETERMINISTIK (~0 token).
//
...
export const KODE_GUARD_ROBOT = {
  'BE-SWALLOWED-ERROR': 'engine/swallowed-error-check.mjs',
  'OPS-ENV-DRIFT': 'engine/env-keys-check.mjs',
  'PERF-WEIGHT-BUDGET': 'engine/perf-budget.mjs',
  'SEC-CLIENT-SECRET': 'engine/ai-config-check.mjs',
  'OPS-SECRET-IN-REPO': 'engine/install-secret-hook.mjs',
  'DEP-VULN-UNPINNED': 'engine/stack-check.mjs',
}
...
export const KALIMAT_BATAS_AGREGAT = [
  ...
  '- Robot memverifikasi KEBERADAAN penjaga terdaftar, BUKAN kelayakan/cakupannya.',
