#!/usr/bin/env node
// engine/kimi/kimi-hook-io.mjs - Lapisan I/O hook untuk Kimi Code CLI.
//
// KENAPA ADA: kit memakai otak keputusan yang SAMA (engine/risk-gate.js decide(), engine/fact-gate.mjs, dll)
