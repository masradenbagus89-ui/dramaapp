#!/usr/bin/env node
// engine/kimi/risk-gate-kimi.mjs - "Palang Rem" versi Kimi Code (PreToolUse hook).
//
// KENAPA ADA: di Claude Code, engine/risk-gate.js meminta KONFIRMASI klik (mode "ask") untuk aksi
...
//
// OTAK KEPUTUSAN DIPAKAI ULANG dari engine/risk-gate.js decide() (JANGAN tulis-ulang logika risiko -
// satu sumber kebenaran). Berkas ini cuma memetakan keputusan Claude -> kontrak Kimi (lewat
// engine/kimi/kimi-hook-io.mjs). Deteksi berbasis-PERINTAH memakai `tool_input.command` yang dipastikan
