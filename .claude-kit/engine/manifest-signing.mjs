...
//
// SEJARAH: dulu GANDENG dgn lib/manifest-signing.ps1 (dihapus v2.0.0) — keduanya harus hasilkan
...
// ditangani FAIL-SECURE oleh engine/rollback.mjs (butuh --accept-untrusted-manifest). PowerShell sudah
// dihapus v2.0.0; klien tim kini di v2.6+ (sudah bersegel format-baru), jadi kasus ini praktis tak muncul.
