#!/usr/bin/env node
// engine/perf-budget.mjs - Penjaga Anggaran Ukuran Halaman (Next.js). Baca manifest build Next.js lalu
...
// --- CLI: `node engine/perf-budget.mjs [--project-root <dir>] [--budget-kb 500]` ---
function main() {
