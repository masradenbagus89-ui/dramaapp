...
// Pakai: node engine/plan-scout.mjs "<kata kunci>" --project-root <repo> [--json] [--top <n>]
//        node engine/plan-scout.mjs --project-root <repo> --migration-timeline <objek>
//        node engine/plan-scout.mjs --project-root <repo> --reverse-ref <NamaKomponen>
...
export function scoreFile({ filenameHits, contentHits, importHint = 0 }) {
