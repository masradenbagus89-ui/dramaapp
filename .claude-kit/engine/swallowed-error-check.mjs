#!/usr/bin/env node
// engine/swallowed-error-check.mjs - Robot "Error-ditelan-diam" (deterministik, ~0 token AI, CUMA-BACA).
//
...
// penjelajah-berkas + guard isMain meniru engine/unicode-safety-check.mjs (robot sejenis yang sudah teruji).
...
const SKIP_FRAGMENTS = [
  ...
  '\\.backup-', '\\.claude-kit.backup-', '\\.claude-kit\\',
]
