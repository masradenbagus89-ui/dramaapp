#!/usr/bin/env node
// lib/feedback-scrub.mjs - Robot redaksi DETERMINISTIK 2-lapis untuk berkas "Rekam Pelajaran" (~0 token).
//
...
const PLACEHOLDER_LITERAL = new Set(['<ID>', '<DOMAIN>', '<PROJECT>', '<KLIEN>', '<ORANG>', '[DIREDAKSI]', '****', '[id]', '[slug]'])
...
// --- CLI: node lib/feedback-scrub.mjs <scrub|verify> <path|dir> ---
function main() {
