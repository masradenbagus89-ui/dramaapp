#!/usr/bin/env node
// lib/project-id.mjs - Hitung 3 ID hash-anonim (ORG/REPO/STAFF) dari git, DETERMINISTIK (~0 token).
//
...
// Bentuk ID sah (dipakai-ULANG C2 lib/feedback-aggregate.mjs untuk deteksi ID cacat/placeholder).
...
// lib/manifest.mjs (itu hash BERKAS dengan kontrak beda) - prompt memakai .digest('hex').slice(0,8) lowercase.
...
// --- CLI: node lib/project-id.mjs [--project-root <dir>] [--json] ---
