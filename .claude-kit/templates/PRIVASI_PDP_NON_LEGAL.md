# PRIVASI_PDP_NON_LEGAL — Panduan Data Pribadi (UU PDP) untuk Tim Tanpa Jalur Hukum
...
- Consent & cookie (analytics) → `workflows/cap/analytics.md` (bagian consent).
- Retensi & hapus data (mekanik) → `workflows/cap/upload-storage.md`.
- Respon + notifikasi kebocoran → `templates/SECURITY_INCIDENT_PLAYBOOK.md`.
- Operasi DB aman (kolom sensitif, migrasi) → `templates/OPERASI_DATABASE_AMAN.md` + `templates/RLS_SETUP_PROMPT.md`.
- Industri teregulasi (KYC/AML) → `workflows/cap/kepatuhan-teregulasi.md`.
...
- **Dependensi:** `SECURITY_INCIDENT_PLAYBOOK.md`, `RLS_SETUP_PROMPT.md`, `OPERASI_DATABASE_AMAN.md`, `workflows/cap/analytics.md`, `workflows/cap/upload-storage.md`.
