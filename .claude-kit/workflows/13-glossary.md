...
- **Refactoring** (*in-place*) - rapikan kode tanpa ubah struktur/perilaku (nama, hapus duplikat, pecah fungsi). Tetap 1 repo. = Tangga Refactor **Tingkat 1** (default). Detail: `workflows/4.2-pattern-driven.md`.
