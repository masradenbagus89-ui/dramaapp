...
// Sub-perintah CLI kit yang cuma-baca. WAJIB cermin dispatcher client (bin/lintasai.js COMMANDS_NODE):
// nama yang sudah TIDAK ada di sana = entri mati yang menipu pembacanya.
// DIRAPIKAN 2026-08-03: 'preflight' · 'env-keys' · 'unicode-check' · 'plan-scout' DICABUT - keempatnya
// termasuk 19 perintah maintainer yang dibuang dari dispatcher client di v6.0.0 (robotnya pindah ke
// <repo>/tools/ yang tak dikirim ke client). Sesi dev TIDAK terdampak: `npm run preflight` tetap lolos
// lewat SKRIP_PROYEK di bawah. SENGAJA cuma MENGHAPUS, tak menambah nama baru: daftar ini memberi izin
// OTOMATIS, jadi menambah = melebarkan permukaan izin (butuh bukti cuma-baca per perintah dulu).
