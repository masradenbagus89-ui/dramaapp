...
> **Inti:** analytics menghitung berapa yang datang & apa yang mereka lakukan untuk dasar keputusan, TAPI **jangan diam-diam mencatat data pribadi** (nama, no. HP, isi keranjang) tanpa izin — itu melanggar kepercayaan dan hukum.

Butir **🔒 HASIL** = jaminan privasi & akurasi yang tak boleh gagal.
...
4. 💡 **SARAN — Pilih alat sesuai kebutuhan privasi:**
   ...
   - 🔒 HASIL: **Default-bahaya GA4/Consent Mode** — tanpa konfigurasi consent, tag mengumpulkan data SEBELUM persetujuan; set consent default **DENIED**, ubah ke **granted** HANYA setelah user setuju (consent-first).
...
7. 📐 **CARA BAKU — Jaga performa:** skrip analytics jangan blok render (muat `async`/`defer`); batasi jumlah skrip pihak ketiga (tiap skrip = beban + risiko privasi); hormati sinyal "Do Not Track"/Global Privacy Control (sinyal browser "jangan lacak saya") bila relevan.
...
- 🗃️ LATAR: 3 aksi inti + performa (jangan blok render) → baseline Frontend/SEO & `skills/seo/SKILL.md`.
- 🗃️ LATAR: Konversi/pembayaran diukur dari webhook server → `skills/pembayaran/SKILL.md`.
- 🗃️ LATAR: Consent & data pribadi (privasi) → peta-jalan `templates/PRIVACY_PDP_NON_LEGAL.md`.
