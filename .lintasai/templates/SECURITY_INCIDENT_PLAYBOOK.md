...
```bash
node .lintasai/engine/install-secret-hook.mjs
```
...
Sumber: <GitHub Secret Scanning / penjaga rahasia CI / email Vercel / dll>
...
> Ini prosedur standar untuk membatasi risiko, bukan kecurigaan berlebihan terhadap staf yang resign.
