...
- Owner sudah baca Decision Matrix di `STACK_GUIDE.md` section 8 dan memutuskan pindah.
...
- [ ] Sudah baca `STACK_GUIDE.md` section 8 (Decision Matrix) dan paham trade-off vendor lock-in.
...
- Decision Matrix vendor: `templates/STACK_GUIDE.md` section 8
