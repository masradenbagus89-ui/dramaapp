...
- [2026-09-07-beranda-lk21.md](./rencana/2026-09-07-beranda-lk21.md) — Beranda dirombak jadi gaya situs streaming klasik (bar cari magenta, strip genre, **grid poster padat + paginasi**) digabung hero sinematik & baris personal. Pelajaran pre-mortem: badge & filter HANYA dari field yang benar-benar terisi — katalog tak punya `year`/`country`/kualitas video, jadi filter Negara & badge HD/CAM SENGAJA tidak dibangun (memasangnya = berbohong ke penonton)
