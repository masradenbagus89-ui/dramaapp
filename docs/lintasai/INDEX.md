...
- [2026-08-29-playly-video-tanpa-berkas.md](./rencana/2026-08-29-playly-video-tanpa-berkas.md) — video Playly yang **catatannya ada tapi berkasnya tidak** (upload putus) berhenti diantar ke penonton: penyaring `punyaFileVideo` + badge "belum siap" di admin. Berisi keputusan 3-keadaan (`null` = TIDAK TAHU → video TETAP tampil) supaya perubahan bentuk JSON di pihak Playly tak menghapus semua video sekaligus
