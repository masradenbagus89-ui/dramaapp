...
Info "Catatan jujur: jeda awal TIDAK hilang, cuma berkurang. Film panjang punya"
Info "  daftar isi (moov) beberapa MB yang harus dimuat dulu - pada Over Your Dead"
Info "  Body: 5,1 MB -> 3,0 MB, jeda ~28 detik -> ~19 detik. Sesudah jalan, barulah"
Info "  lancar karena berkasnya sudah muat di kapasitas tunnel."
