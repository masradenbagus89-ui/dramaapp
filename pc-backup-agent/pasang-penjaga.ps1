...
Info "Untuk antivirus pihak ketiga (di PC backup ini: 360 Total Security), exclusion"
Info "dipasang lewat aplikasinya sendiri - cari White List atau Trust List."
